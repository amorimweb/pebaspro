...
// UI State
const activeTab = ref('sobre') // sobre, exp, edu
const newSkill = ref('')
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-10">
            ...
            <div class="lg:col-span-1 space-y-3">
                <button @click="activeTab = 'sobre'" :class="activeTab === 'sobre' ? 'bg-slate-900 text-white shadow-xl shadow-slate-900/20' : 'bg-white text-slate-500 hover:bg-slate-50 border border-slate-100'" class="w-full text-left px-6 py-4 rounded-2xl font-black transition-all flex items-center gap-4 uppercase text-xs tracking-widest">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                    Sobre Mim
                </button>
                <button @click="activeTab = 'exp'" :class="activeTab === 'exp' ? 'bg-slate-900 text-white shadow-xl shadow-slate-900/20' : 'bg-white text-slate-500 hover:bg-slate-50 border border-slate-100'" class="w-full text-left px-6 py-4 rounded-2xl font-black transition-all flex items-center gap-4 uppercase text-xs tracking-widest">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                    Experiência
                </button>
                <button @click="activeTab = 'edu'" :class="activeTab === 'edu' ? 'bg-slate-900 text-white shadow-xl shadow-slate-900/20' : 'bg-white text-slate-500 hover:bg-slate-50 border border-slate-100'" class="w-full text-left px-6 py-4 rounded-2xl font-black transition-all flex items-center gap-4 uppercase text-xs tracking-widest">
            ...
            <!-- Content Area -->
            <div class="lg:col-span-3 bg-white rounded-[40px] shadow-2xl shadow-slate-200/50 border border-slate-100 p-10 min-h-[600px]">
                
                <!-- Tab: Sobre Mim -->
                <div v-if="activeTab === 'sobre'" class="space-y-10 animate-in fade-in slide-in-from-right-4 duration-300">
                ...
                <!-- Tab: Experiência -->
                <div v-if="activeTab === 'exp'" class="space-y-8 animate-in fade-in slide-in-from-right-4 duration-300">
                    <div class="flex justify-between items-center">
                        <h3 class="text-2xl font-black text-slate-900 tracking-tight">Experiência Profissional</h3>
                        <button @click="showExpModal = true" class="px-6 py-3 bg-green-50 text-green-700 rounded-xl hover:bg-green-100 font-black text-sm transition">+ Novo Item</button>
                    </div>
                ...
                <!-- Tab: Formação -->
                <div v-if="activeTab === 'edu'" class="space-y-8 animate-in fade-in slide-in-from-right-4 duration-300">
                     <div class="flex justify-between items-center">
                        <h3 class="text-2xl font-black text-slate-900 tracking-tight">Formação Acadêmica</h3>
                        <button @click="showEduModal = true" class="px-6 py-3 bg-green-50 text-green-700 rounded-xl hover:bg-green-100 font-black text-sm transition">+ Novo Item</button>
                    </div>
