...
- Cadastro começa em \`/cadastro\`, onde a pessoa escolhe o perfil: Talento, Prestador ou Empresa.
- O cadastro completo segue em \`/cadastro/dados\` com cinco etapas:
  - Identificação: tipo de perfil, nome ou razão social, CPF/CNPJ e WhatsApp.
  - Localização: cidade, estado, bairro e endereço de referência opcional.
  - Apresentação: profissão/especialidade/segmento e resumo; talento também informa objetivo e habilidades.
  - Revisão dos dados.
  - Criação de acesso: e-mail e senha, ou Google, após aceitar termos e privacidade.
- A conta só é criada ao final, com o perfil completo.
- Login fica em \`/login\`.
...
- Empresas também podem oferecer serviços se ativarem o campo modo_prestador.
